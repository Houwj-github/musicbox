    ...
    <div class='a'>
        <table class="table_0">
            <tr style="height:50px;">
                ...
                <td style="font-size:20px;width:150px;">时长</td>
            ...
            <tr v-for="(song, index) in displayedSongs" :key="index" class="col_td">
                <td class="centent_i" @click="goSong(song.id,song.status)"><i v-if="song.isVip" class="vip-layout" :class="{bg:song.isVip}">VIP</i>{{ song.songName }}</td>
