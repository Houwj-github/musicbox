...
<script>
import {getMyPostAPI} from '@/request/api'
import {delMyPostAPI} from '@/request/api'
    ...
    methods:{
        getPost(){
            getMyPostAPI().then(res=>{
                console.log(res)
                if(res.success){
                    this.post_page=res.data.myPost
                }
